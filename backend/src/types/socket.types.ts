...
export interface ServerToClientEvents {
    ...
    memberBanned: (roomId: string, userId: string, bannedBy: string, banDetails: BanDetails) => void;
...
export interface ClientToServerEvents {
    ...
    joinRoom: (payload: { method: 'code' | 'id', data: string }, ack: AckFunc<{ roomId: string, ban?: Omit<BanDetails, 'reason'> }>) => void;
