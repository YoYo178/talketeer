...
export const ResetPage = () => {
  ...
  const requestResetMutation = useRequestPasswordResetMutation({
    queryKey: ['request-password-reset', email],
  });
    ...
    <div className='flex flex-col gap-6'>
      <div className='flex flex-col items-center gap-2 text-center'>
        ...
        <p className='text-sm text-muted-foreground mb-4'>
          You're about to reset your password. Make sure to choose one that's secure and memorable!
        </p>
      ...
      <div className='flex flex-col gap-6'>
        <div className='flex flex-col items-center gap-2 text-center'>
          ...
          <p className='text-muted-foreground'>
            We've sent a password reset link to your email. Follow the instructions to set a new
            password.
          </p>
          <Button className='my-2 px-8' onClick={navigateToHome}>
            Ok
          </Button>
        </div>
      </div>
