...
export const NavBar = () => {
  ...
  return (
    <div className='flex items-center bg-accent dark:bg-primary-foreground rounded-xl px-5'>
      {isMobile ? (
        <div
          className={`overflow-hidden origin-left transition-[opacity,visibility,max-width] ease-out ${!isAvatarCardOpen ? 'opacity-100 visible max-w-[200px] duration-800' : 'opacity-0 invisible max-w-0 duration-300'}`}
        >
