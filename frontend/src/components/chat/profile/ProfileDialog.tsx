    ...
    <Dialog open={isProfileDialogOpen} onOpenChange={setIsProfileDialogOpen}>
      <DialogContent className='max-h-[85vh] overflow-hidden'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-2'>
                ...
                <div className='flex-1 flex flex-col gap-4'>
                  <div className='flex-1 flex gap-2'>
                    <div className='flex flex-col gap-2'>
                      ...
                      <Input
                        defaultValue={initialFormState.firstName}
                        {...register('firstName')}
                    ...
                    <div className='flex flex-col gap-2'>
                      ...
                      <Input
                        defaultValue={initialFormState.lastName}
                        {...register('lastName')}
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <Input
                      defaultValue={initialFormState.displayName}
          ...
          <DialogFooter>
            {errors.general && (
              <p className='mr-auto text-sm text-red-500 self-center text-center'>
                {errors.general}
              </p>
            )}
            <DialogClose asChild>
