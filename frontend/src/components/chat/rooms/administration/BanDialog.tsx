        ...
        <form className='flex flex-col gap-6' onSubmit={handleSubmit}>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <Select value={duration} onValueChange={setDuration}>
                    ...
                    <SelectContent side='right'>
                      {banDurations.map((durationObj) => (
                        <SelectItem
                          key={`ban-duration-${durationObj.label}`}
                          value={getDurationValue(durationObj.minutes)}
                        >
                          {durationObj.label}
                        </SelectItem>
                      ))}
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction asChild>
              <Button className='bg-red-600 hover:bg-red-500 dark:text-primary' type='submit'>
                Ban
              </Button>
            </AlertDialogAction>
          </AlertDialogFooter>
