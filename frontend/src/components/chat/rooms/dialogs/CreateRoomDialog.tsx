    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Pick a name and adjust settings accordingly for your room.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className='grid gap-3'>
          ...
          <ToggleGroup
            ...
            className='w-full'
          >
            <ToggleGroupItem value='public' className='flex-1 cursor-pointer'>
              Public
            </ToggleGroupItem>
            <ToggleGroupItem value='private' className='flex-1 cursor-pointer'>
              Private
            </ToggleGroupItem>
          </ToggleGroup>
